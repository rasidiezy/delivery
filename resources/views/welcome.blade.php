    ...
    <div class="modal fade modal-center" id="modalDiskon" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content animate-bottom">
                ...
                <div class="modal-body">
                    <div id="alertDiscount" class="alert alert-success hided" role="alert">
                       <p id="alertDiskon"></p>
                      </div>
                    <div id="alertDiscount1" class="alert alert-danger hided" role="alert">
                       <p id="diskonUnavailable"></p>
                      </div>
                        ...
                        <div class="col-12 diskon-data mb-2" data-percentage="{{ $diskon->persentase }}"
                            ...
                            <div class="row diskon-row">
                                ...
                                <div class="col-6 disc-text">
                                    ...
                                    <p class="min-ongkir">Minimal ongkir {{ @currency($diskon->min_ongkir) }}</p>
                                    <p class="min-ongkir text-success">Berakhir : {{\Carbon\Carbon::parse($diskon->end_discount)->format('d-m-Y') }}</p>
                                </div>
                                <div class="col-2 d-flex align-items-center">
                                    <img src="{{ asset('images/tick.png') }}" class="icon-selected-discount hided" alt="">
                                </div>
                            </div>
                        </div>
                        @endforeach
            ...
            <div class=" col-lg-12 col-12 margin-padding">
                ...
                <div>
                    ...
                    <form action="{{ route('order.store') }}" id="test" class="basic-form" method="post">
                        ...
                        <div class="checkbox form-group mb-2">
                            <label>
                                <input id="addOrder1" type="checkbox" name="ch01" @if(old('ch01')) checked
                                    @endif>Permintaan
                                Pesanan Tambahan
                            </label>
                ...
                <div class="row mb-2">
                    <div id="my-div" class="mb-3 mt-3">
                        <a href="#" data-toggle="modal" id="voucher" data-target="#modalDiskon" class="fill-div">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input id="diskon" name="jarak" type="text" value="Gunakan kode >">
                                </div>
                            </div>
                        </a>
                    </div>
                            ...
                            <div class="box-sd">
                                ...
                                <div class="container ongkir">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <input id="ongkir" name="ongkir" type="text" value={{@currency('15000')  }}
                                                style="text-align:right;">
                                ...
                                <div class="container ongkir">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <input id="biayarq" name="biaya_rq" type="text" value="{{old('biaya_rq')}}"
                                                style="text-align:right;">
                                            </h4>
                                        </div>
                                    </div>
